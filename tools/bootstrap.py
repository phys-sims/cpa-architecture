...
REFS_LOCK = ROOT / "manifest" / "refs.lock"
DEPS_DIR = ROOT / "deps"
...
def write_refs_lock(specs: list[RepoSpec]) -> None:
    lines = ["# Generated by tools/bootstrap.py", "# Format: <repo> <head_sha>"]
